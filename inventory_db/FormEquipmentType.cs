...
namespace inventory_db
{
    public partial class FormEquipmentType : Form
    {
        ...
        private void RefreshlistViewEquipment()
        {
            ...
            {
                sqlConnection.Open();
                MySqlCommand sqlCommand = new MySqlCommand("SELECT col_type_equipment_name " +
                                                           "FROM tb_type_equipment ", sqlConnection);
        ...
        private void buttonAddNewEquipment_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand command = new MySqlCommand("SELECT * FROM `tb_type_equipment` WHERE col_type_equipment_name = @col_type_equipment_name", sqlConnection);
            command.Parameters.Add("@col_type_equipment_name", MySqlDbType.VarChar).Value = textBoxAddNewEquipment.Text;
            ...
            string query = "INSERT INTO tb_type_equipment(`col_type_equipment_name`) " +
                "VALUES (@col_type_equipment_name)";
            MySqlCommand commandDatabase = new MySqlCommand(query, sqlConnection);

            commandDatabase.Parameters.Add("@col_type_equipment_name", MySqlDbType.VarChar).Value = textBoxAddNewEquipment.Text;
        ...
        private void methodChangeEquipment()
        {
            ...
            else
            {
                ...
                MySqlDataAdapter adapter = new MySqlDataAdapter();
                MySqlCommand command = new MySqlCommand("SELECT * FROM `tb_type_equipment` WHERE col_type_equipment_name = @col_type_equipment_name", sqlConnection);
                command.Parameters.Add("@col_type_equipment_name", MySqlDbType.VarChar).Value = textBoxChangeEquipment.Text;
                ...
                string query = "UPDATE `tb_type_equipment` " +
                    "SET `col_type_equipment_name`=@col_type_equipment_name " +
                    "WHERE col_type_equipment_name = @equipment_old_name";

                MySqlCommand commandDatabase = new MySqlCommand(query, sqlConnection);
                commandDatabase.Parameters.Add("@col_type_equipment_name", MySqlDbType.VarChar).Value = location;
        ...
        private void labelEquipment_Click(object sender, EventArgs e)
        {
